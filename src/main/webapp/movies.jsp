				...
				<div class="owl-four owl-carousel owl-theme">
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="assets/images/marvel.jpg" alt="">
								</figure>
								<div class="box-content">
									<h3 class="title">Marvel</h3>
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="assets/images/bahubali.jpg" alt="">
								</figure>
								<div class="box-content">
									<h3 class="title">Bahubali The Begining</h3>
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="assets/images/hariotter.jpg" alt="">
								</figure>
								<div class="box-content">
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="assets/images/master.jpg" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="assets/images/kgf.jpg" alt="">

								</figure>
								<div class="box-content">
									<h3 class="title">KGF</h3>
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> 1 Hr 4min
				...
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						...
						<div class="headerhny-right text-lg-right">
							<h4><a class="show-title" href="movies.jsp">Show all</a></h4>
						</div>
					</div>
				</div>
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/kantara.jpg" alt="">
							</figure>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="assets/images/kantara.jpg" class="img-fluid modalimg" alt="" />
											<p>
												<h3>Release Date&nbsp;:30 September 2022</h3>
											</p>
											<h4>About Movie</h4>
											<p>
												A death in the village of Dakshina Kannada leads to a war between the villagers and the forces of evil.
											</p>
										
										</div>
										<div class="bookbtn">
											<button type="button" class="btn btn-success"
												onclick="location.href='ticket-booking.jsp';">Book</button>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/ps1.jpg" alt="">
							</figure>
							<a href=".Knivesout" data-toggle="modal">
								<div class="box-content">
									<h3 class="title">PS1</h3>
							...
							<div class="modal fade Knivesout" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="assets/images/ps1.jpg" class="img-fluid modalimg" alt="" />
											<p>
												<h3>Release Date&nbsp;:September 30, 2022 </h3>
												<h3>Venue&nbsp;:Cg Road </h3>
											</p>
											<h4>About Movie</h4>
											<p>
												Vandiyathevan sets out to cross the Chola land to deliver a message from the crown prince Aditha Karikalan. Meanwhile, Kundavai attempts to establish political peace as vassals and petty chieftains plot against the throne.
											</p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/wakanda.jpg" alt="">
							</figure>
							<a href=".Bharat" data-toggle="modal">
								<div class="box-content">
									<h3 class="title">Wakanda ForEver</h3>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="assets/images/bhediya.jpg" alt="">
							</figure>
							<a href=".Bharat" data-toggle="modal">
								<div class="box-content">
									<h3 class="title">Bhediya</h3>
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 35min
							...
							<div class="albums-content">
								<div class="row">
										...
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp">
													...
													<img src="assets/images/kantara.jpg" class="img-fluid"
														alt="author image">
											...
											<div class="message">
												<p>Telugu</p>
												<a class="author-book-title" href="movies.jsp">Kantara</a>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/bhediya.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>Hindi</p>
												<a class="author-book-title" href="movies.jsp">Bhediya</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/wakanda.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												...
												<a class="author-book-title" href="movies.jsp">Wakanda ForEver</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m1.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Rocketman</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m2.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Doctor Sleep</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m3.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Knives Out</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/n1.jpg" class="img-fluid"
														alt="author image">
													<span class="fa fa-play video-icon" aria-hidden="true"></span>
												</a>
											</div>
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">No Time to Die</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/n2.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/n3.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Free Guy</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m7.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Frozen 2</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m8.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Toy Story 4</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.jsp"><img src="assets/images/m9.jpg" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Joker</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
								...
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											...
											<div class="message">
												<p>English</p>
												<a class="author-book-title" href="movies.jsp">Alita</a>
												<h4> <span class="post"><span class="fa fa-clock-o"> </span> 2 Hr 4min
													</span>
